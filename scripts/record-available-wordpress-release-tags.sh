...
record_available_tag "FD_FORMS_RELEASE_TAG" "AVAILABLE_FD_FORMS_RELEASE_TAG" "${FD_FORMS_RELEASE_TAG:-}"
...
grep -E '^(AVAILABLE_(FD_(THEME|PAGE_COMPOSER|ADMIN_UI|MEMBER|PAYMENT|COMMERCE|CONTENT_TYPES|FORMS|AI_ROUTER|WEBSOCKET_PUSH)_RELEASE_TAG|WPGRAPHQL_RELEASE_TAG|WPGRAPHQL_JWT_AUTH_RELEASE_TAG|WPGRAPHQL_TAX_QUERY_REF)|LAST_WORDPRESS_ASSET_UPDATE_OFFERED_AT)=' "${ENV_FILE}" || true
