...
FD_PAGE_COMPOSER_RELEASE_TAG="${FD_PAGE_COMPOSER_RELEASE_TAG:-v0.2.9}"
FD_ADMIN_UI_RELEASE_TAG="${FD_ADMIN_UI_RELEASE_TAG:-v1.3.3}"
...
FD_CONTENT_TYPES_RELEASE_TAG="${FD_CONTENT_TYPES_RELEASE_TAG:-v0.5.0}"
