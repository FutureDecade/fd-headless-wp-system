        ...
        'commerce' => [
            'spec_groups' => [
                [
                    ...
                    'sort_order' => 0,
                    'values' => [
                        ['value' => '个人版', 'sort_order' => 0],
                        ['value' => '团队版', 'sort_order' => 1],
                    ],
                ],
                [
                    'name' => '订阅周期',
                    'sort_order' => 1,
                    'values' => [
                        ['value' => '季度', 'sort_order' => 0],
                        ['value' => '年度', 'sort_order' => 1],
                    ],
                ],
            ],
            'sku_overrides' => [
                [
                    'snapshot' => ['席位方案' => '个人版', '订阅周期' => '季度'],
                    'sku_code' => 'FDBRIEF-PER-Q',
                    'price' => 109,
                    'original_price' => 149,
                    'member_price' => 89,
                    'cost_price' => 32,
                    'stock' => -1,
                    'barcode' => 'FDBRIEF-PER-Q',
                    'sort_order' => 0,
                ],
                [
                    'snapshot' => ['席位方案' => '个人版', '订阅周期' => '年度'],
                    'sku_code' => 'FDBRIEF-PER-Y',
                    'price' => 299,
                    'original_price' => 499,
                    'member_price' => 249,
                    'cost_price' => 88,
                    'stock' => -1,
                    'barcode' => 'FDBRIEF-PER-Y',
                    'sort_order' => 1,
                ],
                [
                    'snapshot' => ['席位方案' => '团队版', '订阅周期' => '季度'],
                    'sku_code' => 'FDBRIEF-TEAM-Q',
                    'price' => 329,
                    'original_price' => 399,
                    'member_price' => 299,
                    'cost_price' => 120,
                    'stock' => -1,
                    'barcode' => 'FDBRIEF-TEAM-Q',
                    'sort_order' => 2,
                ],
                [
                    'snapshot' => ['席位方案' => '团队版', '订阅周期' => '年度'],
                    'sku_code' => 'FDBRIEF-TEAM-Y',
                    'price' => 999,
                    'original_price' => 1399,
                    'member_price' => 899,
                    'cost_price' => 360,
                    'stock' => -1,
                    'barcode' => 'FDBRIEF-TEAM-Y',
                    'sort_order' => 3,
                ],
            ],
        ],
        ...
        'commerce' => [
            'spec_groups' => [
                [
                    ...
                    'sort_order' => 0,
                    'values' => [
                        ['value' => '个人授权', 'sort_order' => 0],
                        ['value' => '团队授权', 'sort_order' => 1],
                    ],
                ],
                [
                    'name' => '交付格式',
                    'sort_order' => 1,
                    'values' => [
                        ['value' => '基础版', 'sort_order' => 0],
                        ['value' => '全格式版', 'sort_order' => 1],
                    ],
                ],
            ],
            'sku_overrides' => [
                [
                    'snapshot' => ['授权版本' => '个人授权', '交付格式' => '基础版'],
                    'sku_code' => 'FDKIT-PER-BASE',
                    'price' => 79,
                    'original_price' => 129,
                    'member_price' => 69,
                    'cost_price' => 18,
                    'stock' => -1,
                    'barcode' => 'FDKIT-PER-BASE',
                    'sort_order' => 0,
                ],
                [
                    'snapshot' => ['授权版本' => '个人授权', '交付格式' => '全格式版'],
                    'sku_code' => 'FDKIT-PER-FULL',
                    'price' => 129,
                    'original_price' => 169,
                    'member_price' => 99,
                    'cost_price' => 26,
                    'stock' => -1,
                    'barcode' => 'FDKIT-PER-FULL',
                    'sort_order' => 1,
                ],
                [
                    'snapshot' => ['授权版本' => '团队授权', '交付格式' => '基础版'],
                    'sku_code' => 'FDKIT-TEAM-BASE',
                    'price' => 199,
                    'original_price' => 259,
                    'member_price' => 179,
                    'cost_price' => 60,
                    'stock' => -1,
                    'barcode' => 'FDKIT-TEAM-BASE',
                    'sort_order' => 2,
                ],
                [
                    'snapshot' => ['授权版本' => '团队授权', '交付格式' => '全格式版'],
                    'sku_code' => 'FDKIT-TEAM-FULL',
                    'price' => 299,
                    'original_price' => 399,
                    'member_price' => 269,
                    'cost_price' => 96,
                    'stock' => -1,
                    'barcode' => 'FDKIT-TEAM-FULL',
                    'sort_order' => 3,
                ],
            ],
        ],
        ...
        'commerce' => [
            'spec_groups' => [
                [
                    ...
                    'sort_order' => 0,
                    'values' => [
                        ['value' => 'Sand', 'sort_order' => 0],
                        ['value' => 'Graphite', 'sort_order' => 1],
                    ],
                ],
                [
                    'name' => '尺寸',
                    'sort_order' => 1,
                    'values' => [
                        ['value' => 'Large', 'sort_order' => 0],
                        ['value' => 'XL', 'sort_order' => 1],
                    ],
                ],
            ],
            'sku_overrides' => [
                [
                    'snapshot' => ['颜色' => 'Sand', '尺寸' => 'Large'],
                    'sku_code' => 'FDMAT-SAND-L',
                    'price' => 169,
                    'original_price' => 229,
                    'member_price' => 149,
                    'cost_price' => 72,
                    'stock' => 18,
                    'barcode' => 'FDMAT-SAND-L',
                    'sort_order' => 0,
                ],
                [
                    'snapshot' => ['颜色' => 'Sand', '尺寸' => 'XL'],
                    'sku_code' => 'FDMAT-SAND-XL',
                    'price' => 189,
                    'original_price' => 249,
                    'member_price' => 169,
                    'cost_price' => 86,
                    'stock' => 10,
                    'barcode' => 'FDMAT-SAND-XL',
                    'sort_order' => 1,
                ],
                [
                    'snapshot' => ['颜色' => 'Graphite', '尺寸' => 'Large'],
                    'sku_code' => 'FDMAT-GRAPHITE-L',
                    'price' => 169,
                    'original_price' => 229,
                    'member_price' => 149,
                    'cost_price' => 72,
                    'stock' => 12,
                    'barcode' => 'FDMAT-GRAPHITE-L',
                    'sort_order' => 2,
                ],
                [
                    'snapshot' => ['颜色' => 'Graphite', '尺寸' => 'XL'],
                    'sku_code' => 'FDMAT-GRAPHITE-XL',
                    'price' => 189,
                    'original_price' => 249,
                    'member_price' => 169,
                    'cost_price' => 86,
                    'stock' => 8,
                    'barcode' => 'FDMAT-GRAPHITE-XL',
                    'sort_order' => 3,
                ],
            ],
        ],
