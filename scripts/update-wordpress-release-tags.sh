...
if [[ -z "${NEW_FD_THEME_RELEASE_TAG}" && -z "${NEW_FD_ADMIN_UI_RELEASE_TAG}" && -z "${NEW_FD_MEMBER_RELEASE_TAG}" && -z "${NEW_FD_PAYMENT_RELEASE_TAG}" && -z "${NEW_FD_COMMERCE_RELEASE_TAG}" && -z "${NEW_FD_WEBSOCKET_PUSH_RELEASE_TAG}" && -z "${NEW_WPGRAPHQL_JWT_AUTH_RELEASE_TAG}" && -z "${NEW_WPGRAPHQL_TAX_QUERY_REF}" ]]; then
...
grep -E '^(FD_(THEME|ADMIN_UI|MEMBER|PAYMENT|COMMERCE|WEBSOCKET_PUSH)_RELEASE_TAG|WPGRAPHQL_JWT_AUTH_RELEASE_TAG|WPGRAPHQL_TAX_QUERY_REF)=' "${ENV_FILE}"
