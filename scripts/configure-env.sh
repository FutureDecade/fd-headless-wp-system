...
fd_theme_release_tag_default="${FD_THEME_RELEASE_TAG:-v1.1.4}"
fd_page_composer_release_tag_default="${FD_PAGE_COMPOSER_RELEASE_TAG:-v0.2.13}"
fd_admin_ui_release_tag_default="${FD_ADMIN_UI_RELEASE_TAG:-v1.3.4}"
fd_member_release_tag_default="${FD_MEMBER_RELEASE_TAG:-v1.0.6}"
fd_payment_release_tag_default="${FD_PAYMENT_RELEASE_TAG:-v1.0.3}"
fd_commerce_release_tag_default="${FD_COMMERCE_RELEASE_TAG:-v1.0.0}"
fd_content_types_release_tag_default="${FD_CONTENT_TYPES_RELEASE_TAG:-v0.5.1}"
fd_forms_release_tag_default="${FD_FORMS_RELEASE_TAG:-v0.1.0}"
fd_ai_router_release_tag_default="${FD_AI_ROUTER_RELEASE_TAG:-v2.2.5}"
fd_websocket_push_release_tag_default="${FD_WEBSOCKET_PUSH_RELEASE_TAG:-v1.0.12}"
...
if [[ "${wordpress_fetch_release_assets}" == "true" ]]; then
  if [[ "${stack_bootstrap_mode}" == "true" ]]; then
    ...
    fd_forms_release_tag="${fd_forms_release_tag_default}"
    ...
    fd_forms_release_tag="$(prompt_required_value "fd-forms release tag" "${fd_forms_release_tag_default}")"
  ...
  set_env_value "${ENV_FILE}" "FD_FORMS_RELEASE_TAG" "${fd_forms_release_tag}"
