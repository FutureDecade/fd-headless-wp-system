...
fd_page_composer_release_tag_default="${FD_PAGE_COMPOSER_RELEASE_TAG:-v0.2.9}"
fd_admin_ui_release_tag_default="${FD_ADMIN_UI_RELEASE_TAG:-v1.3.3}"
...
fd_content_types_release_tag_default="${FD_CONTENT_TYPES_RELEASE_TAG:-v0.5.0}"
