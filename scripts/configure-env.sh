...
fd_theme_release_tag_default="${FD_THEME_RELEASE_TAG:-v1.0.7}"
...
fd_content_types_release_tag_default="${FD_CONTENT_TYPES_RELEASE_TAG:-v0.4.0}"
fd_ai_router_release_tag_default="${FD_AI_ROUTER_RELEASE_TAG:-v2.2}"
