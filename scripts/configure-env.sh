...
fd_theme_release_tag_default="${FD_THEME_RELEASE_TAG:-v1.0.9}"
fd_admin_ui_release_tag_default="${FD_ADMIN_UI_RELEASE_TAG:-v1.3.2}"
fd_member_release_tag_default="${FD_MEMBER_RELEASE_TAG:-v1.0.3}"
...
fd_content_types_release_tag_default="${FD_CONTENT_TYPES_RELEASE_TAG:-v0.4.2}"
fd_ai_router_release_tag_default="${FD_AI_ROUTER_RELEASE_TAG:-v2.2.2}"
fd_websocket_push_release_tag_default="${FD_WEBSOCKET_PUSH_RELEASE_TAG:-v1.0.2}"
