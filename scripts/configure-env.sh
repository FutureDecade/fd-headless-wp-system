...
fd_theme_release_tag_default="${FD_THEME_RELEASE_TAG:-v1.0.8}"
fd_admin_ui_release_tag_default="${FD_ADMIN_UI_RELEASE_TAG:-v1.3.2}"
fd_member_release_tag_default="${FD_MEMBER_RELEASE_TAG:-v1.0.2}"
fd_payment_release_tag_default="${FD_PAYMENT_RELEASE_TAG:-v1.0.1}"
