...
fd_content_types_release_tag_default="${FD_CONTENT_TYPES_RELEASE_TAG:-v0.4.4}"
fd_forms_release_tag_default="${FD_FORMS_RELEASE_TAG:-v0.1.0}"
fd_ai_router_release_tag_default="${FD_AI_ROUTER_RELEASE_TAG:-v2.2.4}"
fd_websocket_push_release_tag_default="${FD_WEBSOCKET_PUSH_RELEASE_TAG:-v1.0.3}"
