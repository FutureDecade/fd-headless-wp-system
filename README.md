...
- 如果只想更新 WordPress 交付资产版本，可以运行 `FD_THEME_RELEASE_TAG=v1.0.7 FD_CONTENT_TYPES_RELEASE_TAG=v0.1.0 FD_WEBSOCKET_PUSH_RELEASE_TAG=v1.0.0 WPGRAPHQL_JWT_AUTH_RELEASE_TAG=v0.7.2 WPGRAPHQL_TAX_QUERY_REF=v0.2.0 bash scripts/update-wordpress-release-tags.sh`
